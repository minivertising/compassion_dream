...
*/
		...
		return $ch_data['idx']."||".$ch_data['ch_full_img_url']."||".$ch_data['ch_nick']."||".$ch_data['ch_nation_name'];
	}
...
*/
	...
	function send_lms($phone, $serial)
	{
		...
		$s_url		= "http://www.mnv.kr/MOBILE/current_state.php?rs=".$serial."&ugu=act"; // URL 변경 해야함.
		$httpmethod = "POST";
