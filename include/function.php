<?
	...
	function winner_draw($mb_phone)
	{
		...
		$first_array				= array("N","N","N");
		$second_array			= array("N","N");
...
"(광고) [belif 선물]
이 선물은 이번 주말이 마지막!
선물을 교환할 수 있는 시간이 얼마 남지 않았어요.

선물 하나! 촉촉 화사한 빌리프 봄 선물♥

선물 둘! 첫번째 선물을 받으면서 사용할 수 있는 화이트닝 시트 마스크 구매선물 쿠폰♥

샘플 쿠폰 교환하면, 숨은 구매선물 쿠폰도 받을 수 있어요!

빌리프 투명 촉촉 봄 체험키트(수분 폭탄 크림 10ml, 수분 충전 에센스 10ml) 쿠폰 사용하기 : 
".$s_url."
